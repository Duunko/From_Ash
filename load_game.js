...
function load_game(){
	...
	levels.push([1344,1344,[[10, 5, 4], [3, 5, 5], [5, 5, 6]],400,300]);
	
	levels.push([1344,1344, [[7, 6, 3], [10, 6, 4]], 400, 500]);
	levels.push([1344,1344,[[10, 9, 1],[2, 3, 1, 'x', 4],[8, 4, 1, 'y',2],[12,1,1],[4,10,1,'x',2], [11, 7, 4]], 200, 100]);
	
	//Main Levels
	
	levels.push([1344,1344,[[11,11,1],[4,7,1,'y',6],[10,2,1,'x',3], [11, 7, 4]], 300, 200]);
	levels.push([1344,1344, [[6, 4, 3], [4, 2, 4]], 300, 200]);
	levels.push([1344,1344,[[10,9,1],[12,12,1],[2,2,1,'y',5],[10,2,1],[10,3,1],[6,0,4]], 300, 200]);
	levels.push([1536,1536,[[9,7,1,'y',3],[3,3,1,'y',2],[10,4,1,'x',3],[2,10,1,'x',2], [4, 2, 4]], 300, 200]);
    ...
    levels.push([1536,1536,[[0,8,1,'x',4],[7,8,1,'x',4],[10,0,1,'y',3],[11,2,1,'y',3],
									[13, 8, 4]], 300, 200]);
	levels.push([1536,1728,[[13,4,1,'y',5],[3,3,1,'y',4],[10,4,1,'x',3],[9,9,1,'x',5], [4, 2, 4]], 300, 200]);
	//levels.push([1344,1344, [[6, 4, 3], [4, 2, 4]], 400, 500]);
	levels.push([1536,1536,[[3,4,1,'x',2],[3,5,1,'x',2],[7,0,1,'y',4],[7,8,1,'y',4],[11,2,1,'y',3],
									[10, 10, 4]], 300, 200]);
	levels.push([1344,1344, [[6, 4, 3], [4, 2, 4]], 300, 200]); 
	levels.push([1920, 1472 , [[1, 9, 1, 'x', 6], [10, 1, 1, 'y', 7], [3, 5, 1], [6, 2, 1], [16, 9, 4]], 300, 200]);
   ...
   //Only use enemy A for now, we can add more later							
	...
	enemies.push([[600, 200, 'a'],[900, 900, 'b'], [800, 800, 'b']]);
	enemies.push(undefined);
	enemies.push([[800, 100, 'b'],[300, 900, 'b'],[600, 800, 'c']]);
	
	enemies.push([[800, 100, 'b'],[500, 100, 'b'],[300, 1344/2, 'b'], [800, 700, 'c'], [900, 700, 'c']]); 
	enemies.push([[900, 700, 'b'],[800, 200, 'b'],[600, 222, 'b'],
					  [100, 900, 'b'],[300, 900, 'b'],[600, 922, 'b']]); 
	enemies.push(undefined); 
	enemies.push([[800, 700, 'b'],[300, 700, 'a'],[300, 1344/2, 'b'], [600, 100, 'a'], [1000, 1000, 'c']]); 

	enemies.push([[100, 500, 'a'],[300, 500, 'a'],[400, 992, 'b'],[700, 992, 'b'],[550, 992, 'b']]);
	enemies.push([[800, 700, 'b'],[300, 700, 'a'],[300, 1344/2, 'b'], [600, 100, 'a'], [1000, 1000, 'c']]); 
	enemies.push([[100, 400, 'a'],[300, 800, 'a'],[400, 992, 'b'],[700, 992, 'b'],[1000, 222, 'b'], 
	               [1000, 500, 'c'], [500, 800, 'c']]);
	enemies.push(undefined);
	enemies.push([[400, 550, 'b'], [700, 200, 'b'],[736, 900, 'a'], [100, 1012, 'c'], [320, 1012, 'c'], [490, 1012, 'c'],
	               [1050, 100, 'c'], [1050, 400, 'c'], [1050, 700, 'c'], [1200, 1012, 'b'], [1350, 1012, 'b'], [1500, 1012, 'b'], 
	               [1600, 400, 'a'], [1650, 700, 'b']])
