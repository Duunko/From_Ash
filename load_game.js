...
function load_game(){
	...
	levels = [];
	//Tutorial Levels
	levels.push([960,960,[[7, 1, 4], [4, 5, 5], [5, 5, 6]],100,300]);
	levels.push([960, 960, [[7, 2, 4]], 500, 500]);
	levels.push([960, 960, [[6, 5, 3],[7, 2, 4]], 500, 500]);
	levels.push([960,960,[[10, 9, 1],[2, 3, 1, 'x', 4],[8, 4, 1, 'y',2],[4,10,1,'x',2], [9, 2, 4]], 500, 500]);

	
	//Main Levels
	//levels.push([1280,1280,[[10,9,1],[6,11,1],[12,12,1],[2,2,1,'y',5],[14,2,1],[14,3,1], [16, 2, 4]],500,500]);
	//levels.push([1280,1280,[[11,11,1],[4,7,1,'y',6],[7,10,3],[10,2,1,'x',3], [14, 12, 4]],500,500]);
	levels.push([1280,1280,[[9,7,1,'y',3],[3,3,1,'y',2],[10,4,1,'x',3],[2,10,1,'x',2], [4, 2, 4]],500,500]);
   ...
   enemies.push([[200, 200, 'a'],[400, 200, 'a'],[600, 200, 'a']]);
	//enemies.push([[600, 300, 'a'],[100, 200, 'a']]);
	//enemies.push([[800, 100, 'a'],[300, 100, 'a'],[300, 800, 'a']]);
